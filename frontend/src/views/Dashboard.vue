  ...
  <div class="bg-white p-8 rounded-lg shadow-md mb-4">
    ...
    <div class="flex justify-between items-center mb-4">
      <p class="text-gray-600 m-0">
        Calculate the sum of two integers (0-1023)
      </p>
      <div
        v-if="credits !== null"
        class="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-full font-medium text-sm"
      >
        Credits: {{ credits }}
      </div>
    </div>
    ...
    <div
      v-if="success && result !== null"
      class="text-green-600 bg-green-100 p-3 rounded mb-4 border-l-4 border-green-600"
    >
    ...
    <div class="flex gap-4 mb-4">
      <div class="flex-1">
        <label for="input-a" class="block mb-2 font-medium text-gray-700"
          >Number A</label
        >
        <input
          id="input-a"
      ...
      <div class="flex-1">
        <label for="input-b" class="block mb-2 font-medium text-gray-700"
          >Number B</label
        >
        <input
          id="input-b"
    ...
    <div
      v-if="result !== null"
      class="mt-6 p-6 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg text-white text-center"
    >
